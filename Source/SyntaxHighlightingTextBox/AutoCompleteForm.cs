...
namespace UrielGuy.SyntaxHighlightingTextBox
{
	...
	public class AutoCompleteForm : System.Windows.Forms.Form
	{
        ...
        public SyntaxHighlightingTextBox txtBox { get; set; }
        public ListView List { get { return lstCompleteItems; } }
		...
		private void InitializeComponent()
		{
            ...
            this.lstCompleteItems.Size = new System.Drawing.Size(112, 136);
            this.lstCompleteItems.Sorting = System.Windows.Forms.SortOrder.Ascending;
            this.lstCompleteItems.TabIndex = 1;
            this.lstCompleteItems.TabStop = false;
            this.lstCompleteItems.UseCompatibleStateImageBehavior = false;
            this.lstCompleteItems.View = System.Windows.Forms.View.Details;
            this.lstCompleteItems.Enter += new System.EventHandler(this.lstCompleteItems_Enter);
            this.lstCompleteItems.MouseClick += new System.Windows.Forms.MouseEventHandler(this.lstCompleteItems_MouseClick);
            this.lstCompleteItems.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.lstCompleteItems_MouseDoubleClick);
            // 
            // columnHeader1
            // 
            ...
            this.ClientSize = new System.Drawing.Size(112, 136);
        ...
        private void lstCompleteItems_Enter(object sender, EventArgs e)
        {
        ...
        private void lstCompleteItems_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            txtBox.AcceptAutoCompleteItem();
            txtBox.HideAutoCompleteForm();
        }

        private void lstCompleteItems_MouseClick(object sender, MouseEventArgs e)
        {
